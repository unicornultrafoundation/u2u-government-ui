...
export const delegator  = (data: any, totalStaked: BigNumber): Delegator => {  
  ...
  return {
    ...
    validations: data.validations && data.validations.length > 0 ? data.validations.map((i: any) => validation(i, totalStaked)) : [],
